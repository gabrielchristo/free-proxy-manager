...
class OverviewTab(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.stats_socks4 = QLabel("—")
        self.stats_socks5 = QLabel("—")
        ...
        stats_summary.addRow("SOCKS4", self.stats_socks4)
        stats_summary.addRow("SOCKS5", self.stats_socks5)
    ...
    def _apply_stats(self, payload: dict[str, Any]) -> None:
        ...
        self.stats_socks4.setText(str(payload.get("socks4", "—")))
        self.stats_socks5.setText(str(payload.get("socks5", "—")))
        ...
        for source in sources:
            source_rows.append(
                [
                    ...
                    str(source.get("total_proxies_found", "")),
    ...
    def _clear_stats(self, message: str) -> None:
        ...
        self.stats_socks4.setText("—")
        self.stats_socks5.setText("—")
